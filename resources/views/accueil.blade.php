...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>Génie informatique</span></a></h1>
        ...
        <ul>
          ...
          <li class="drop-down"><a href="">users space</a>
            <ul>
              ...
              <li><a href="/etudiant/login">espace etudiant</a></li>
              <li><a href="/enseignant/login">espace enseignant</a></li>
              <li><a href="/entreprise/login">espace entreprise</a></li>
              <!--
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Bienvenu au license Génie informatique </h1>
