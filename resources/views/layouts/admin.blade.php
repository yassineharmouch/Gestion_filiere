        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#" v-pre>
                            ...
                            <span class="username">{{ Auth::user()->name }}Abdellatif ettagdouini</span>
                            <b class="caret"></b>
                        </a>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
                <a href="{{ url('emplois/create') }}" class="">
          ...
          <li class="sub-menu">
                    ...
                    <ul class="sub">
                    <li><a class="" href="###">afficher les etudiants</a></li>
                    <li><a class="" href="#">afficher un etudiant</a></li>
                    <li><a class="" href="#">modifie un compte</a></li>
                    <li><a class="" href="#">supprimmer un compte</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                  <li><a class="" href="###">afficher les profs</a></li>
                  <li><a class="" href="#">afficher un compte</a></li>
                  <li><a class="" href="#">modifie un compte</a></li>
                  <li><a class="" href="#">supprimer un compte</a></li>
                  </ul>
              </li>
              <li class="sub-menu">
                <a href="javascript:;" class="">
