      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a class="" href="#">ajouter annonce</a></li>
                    <li><a class="" href="#">modifie annonce</a></li>
                    <li><a class="" href="#">suprimer annonce</a></li>
                </ul>
          </li>
          <li>
                    <a class="" href="widgets.html">
                            ...
                            <ul class="sub">
                              <li><a class="" href="#">ajouter offre</a></li>
                              <li><a class="" href="#">modifie offre</a></li>
                              <li><a class="" href="#">suprimer offre</a></li>
                          </ul>
                </li>
          <li class="sub-menu">
