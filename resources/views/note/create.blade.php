      ...
      <div class="row">
          ...
          {{ csrf_field() }}
              ...
              @if($errors->get('matiere'))
                ...
                <div class="form-group  @if($errors->get('semestre')) has-error @endif" >
              <label for=""> Semestre </label>
              <input type="text"  name='semestre' class="form-control" value="{{ old ('semestre') }}" >
              @if($errors->get('semestre'))
                    @foreach($errors->get('semestre') as $message)
                    <li>{{ $message }}</li>
